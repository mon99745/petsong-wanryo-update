...
import com.study.demoProject.domain.order.OrderItemEntity;
import com.study.demoProject.domain.order.OrderRepository;
...
public class OrderService {
    ...
    public Long order(Long ordererId, OrderRequest orderRequest) {
        ...
        List<Long> itemIdList = orderRequest.getOrderLineList().stream()
                .map(ol -> ol.getItemId())
                .collect(Collectors.toList());
        cartService.removeCartLines(orderer.getCode(), itemIdList);
